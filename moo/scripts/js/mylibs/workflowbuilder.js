...
(function() {
  var Activities, Activity, ActivityFactory, Decision, Exit, HumanTask, Loop, PrettyPrintVisitor, ScriptTask, ServiceTask, Signal, Subprocess, Workflow, WorkflowBuilderViewModel, WorkflowXmlConverter, dndOptions,
  ...
  WorkflowXmlConverter = (function() {
    ...
    WorkflowXmlConverter.prototype.createTextNode = function(target, tag, content) {
      return $("<" + tag + "/>").text(content).appendTo(target);
    };
